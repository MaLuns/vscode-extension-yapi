...
const diff = (jsondiffpatch: any, formattersHtml: jsondiffpatch.HtmlFormatter, curDiffData: any) => {
    const json5_parse = (json: any) => {
    ...
    const diffJson = (left: any, right: any) => {
...
export default (curDiffData: any) => diff(jsondiffpatch, formattersHtml, curDiffData);